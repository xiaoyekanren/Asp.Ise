    ...
    public class iseService
{
        ...
        public static ise GetUserByLoginName(string loginName)
        {
            using (SqlConnection cn = new SqlConnection(connectionString))
            {
                cn.Open();
                ...
                string sql = "SELECT * FROM dbo.[User] WHERE Account =@loginName";
                cm.CommandText = sql;
                ...
                if (dr.Read())
                {
                    ise user = new ise
                    {
                        LoginName = (string)dr["Account"],
                        LoginPwd = (string)dr["Password"]
                    };
                    dr.Close();
                    return user;
                }
