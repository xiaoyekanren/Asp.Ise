...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:SqlDataSource ID="下拉列表" runat="server" ConnectionString="<%$ ConnectionStrings:ZzmConnectionString %>" SelectCommand="SELECT DISTINCT PLACE FROM Place"></asp:SqlDataSource>
