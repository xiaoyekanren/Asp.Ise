...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="container-fluid">
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <asp:DropDownList ID="DropDownList1"  runat="server" DataSourceID="SqlDataSource1" DataTextField="PLACE" DataValueField="PLACE" Height="26px" AppendDataBoundItems="True" Width="120px">
        ...
        <br />
        <br />
        <asp:DropDownList ID="DropDownList2" class="btn dropdown-toggle" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource3" DataTextField="PLACE" DataValueField="PLACE" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AppendDataBoundItems="True">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZzmConnectionString %>" SelectCommand="SELECT DISTINCT PLACE FROM Place"></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ZzmConnectionString %>" SelectCommand="SELECT DISTINCT PLACE FROM Place"></asp:SqlDataSource>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <a class="navbar-brand" href="#">使用记录登记</a>
